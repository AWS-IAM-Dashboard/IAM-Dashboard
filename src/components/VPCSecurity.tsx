...
const mockVPCFindings: VPCSecurityFinding[] = [
  {
    ...
    recommendation: "Place non-public workloads in private subnets and minimize Internet Gateway exposure using controlled egress paths",
    is_public: true,
  ...
  },
  {
    ...
    recommendation: "Replace broad CIDRs with least-privilege source ranges or security-group references by application tier",
    is_public: false,
  ...
  },
  {
    ...
    recommendation: "Enable VPC Flow Logs to central logging/SIEM with retention and alerting aligned to incident response requirements",
    is_public: false,
    flow_logs_enabled: false,
    region: "us-east-1",
    risk_score: 72,
  },
  {
    ...
    recommendation: "Tighten database ingress to only required app security groups and approved ports",
    is_public: false,
    flow_logs_enabled: true,
    region: "us-east-1",
    risk_score: 55,
  },
  {
    ...
    recommendation: "Review custom routes for least-path exposure and maintain owner-approved change records",
    is_public: false,
    flow_logs_enabled: true,
    region: "us-east-1",
    risk_score: 30,

...
const mockAccessAnalyzerFindings: AccessAnalyzerFinding[] = [
  {
    ...
    recommendation: "Remove wildcard principals and scope access to approved AWS principals with explicit condition keys",
    is_public: true,
  ...
  },
  {
    ...
    recommendation: "Restrict trust policy to approved account/role ARNs and require external IDs for third-party access",
    is_public: false,
    last_analyzed: new Date().toISOString(),
    risk_score: 88,
  },
  {
    ...
    recommendation: "Constrain Lambda invoke permissions by source account/ARN and only approved caller roles",
    is_public: false,
    last_analyzed: new Date().toISOString(),
    risk_score: 75,
  },
  {
    ...
    recommendation: "Limit KMS key sharing to justified principals, enforce key policy least privilege, and rotate per policy",
    is_public: false,
    last_analyzed: new Date().toISOString(),
    risk_score: 60,
  },
  {
    ...
    recommendation: "Remove anonymous queue access and permit only authenticated producer/consumer roles",
    is_public: true,
    last_analyzed: new Date().toISOString(),
    risk_score: 35,
  },

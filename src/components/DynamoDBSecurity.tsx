...
const mockDynamoDBFindings: DynamoDBSecurityFinding[] = [
  {
    ...
    recommendation: "Enable encryption at rest with KMS and enforce key access least privilege for table consumers",
  ...
  },
  {
    ...
    recommendation: "Enable PITR for production tables and periodically test restore procedures",
  ...
  },
  {
    ...
    recommendation: "Enable deletion protection for critical tables and gate destructive changes through approved change control",
    encryption_enabled: true,
  ...
  },
  {
    ...
    recommendation: "Right-size capacity mode using observed traffic to reduce throttling and cost risk",
    encryption_enabled: true,
    point_in_time_recovery: false,
    deletion_protection: false,
    stream_enabled: false,
  ...
  },
  {
    ...
    recommendation: "Enable Streams only when justified for CDC/audit use cases and restrict stream consumer permissions",
    encryption_enabled: true,
    point_in_time_recovery: true,
